...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 4e1    --40
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians=math.rad(90/TRAJECTORY_BUILDER_2D.submaps.num_range_data/POSE_GRAPH.optimize_every_n_nodes)
